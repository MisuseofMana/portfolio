<template>
    <section class="cardTemplate ifDesktop">
        <section class="flexRowWrap">
            <section class="projectWrapper" v-for="(project, index) in this.allProjects" :key="project.title + index" :style="{background: `url(${require(`../assets/imgs/${project.background}.png`)})`}">   
