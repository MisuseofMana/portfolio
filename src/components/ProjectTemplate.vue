    ...
    <div>
        ...
        <section class="cardBorder ifDesktop hero">
            <section class="flexRowWrap">
                <section class="projectWrapper" v-for="(project, index) in this.content.links" :key="project.title + index" :style="{background: `url(${require(`@/assets/imgs/${project.background}.png`)})`}">   
