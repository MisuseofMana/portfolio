<template>
    <div>
        ...
        <section class="hero">
            <p>As a bolstering force to my visual mediums I also coded this website and create a mutlitiude of <router-link to="/games">games</router-link> using HTML, CSS, Javascript, and Vue.js in my free time.</p>
        </section>
    ...
    export default {
        ...
        computed: {
            filteredLinks: function() {
                const filteredLinks = links.filter(links => links.category === 'Coding')
